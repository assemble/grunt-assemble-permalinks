...
From the same directory as your project's [Gruntfile](https://github.com/gruntjs/grunt/blob/devel/docs/getting_started.md) and [package.json](https://npmjs.org/doc/json.html), install this plugin with the following command:
